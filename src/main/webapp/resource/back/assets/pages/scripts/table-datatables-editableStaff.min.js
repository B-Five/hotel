    ...
    var e = function() {
        ...
        function t(e, t) {
            ...
            a[0].innerHTML = '<input type="text" class="form-control input-small" value="' + n[0] + '">',
                ...
                a[9].innerHTML = '<a class="edit" href="">Save</a>',
                a[10].innerHTML = '<a class="cancel" href="">Cancel</a>'
        }
        function n(e, t) {
            var n = $("input", t);
            e.fnUpdate(n[0].value, t, 0, !1),
                ...
                e.fnUpdate('<a class="edit" href="">Edit</a>', t, 9, !1),
                e.fnUpdate('<a class="delete" href="">Delete</a>', t, 10, !1),
                e.fnDraw()
        }
