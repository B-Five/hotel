    ...
    var e = function() {
        ...
        function t(e, t) {
            ...
            a[0].innerHTML = '<input type="text" class="form-control input-small" value="' + n[0] + '">',
                ...
                a[7].innerHTML = '<input type="text" class="form-control input-small" value="' + n[7] + '">',
                a[8].innerHTML = '<input type="text" class="form-control input-small" value="' + n[8] + '">',
                a[9].innerHTML = '<input type="text" class="form-control input-small" value="' + n[9] + '">',
                a[10].innerHTML = '<a class="edit" href="">Save</a>',
                a[11].innerHTML = '<a class="cancel" href="">Cancel</a>'
        }
        function n(e, t) {
            var n = $("input", t);
            e.fnUpdate(n[0].value, t, 0, !1),
                ...
                e.fnUpdate(n[6].value, t, 6, !1),
                e.fnUpdate(n[7].value, t, 7, !1),
                e.fnUpdate(n[8].value, t, 8, !1),
                e.fnUpdate(n[9].value, t, 9, !1),
                e.fnUpdate('<a class="edit" href="">Edit</a>', t, 10, !1),
                e.fnUpdate('<a class="delete" href="">Delete</a>', t, 11, !1),
                e.fnDraw()
        }
        ...
        $("#sample_editable_1_new").click(function(e) {
            if (e.preventDefault(), o && r) {
                if (!confirm("Previose row not saved. Do you want to save it ?")) return l.fnDeleteRow(r),
                    r = null,
                    void(o = !1);
                n(l, r),
            ...
            a.on("click", ".delete",
                function(e) {
                    if (e.preventDefault(), 0 != confirm("删除此条数据?")) {
            ...
            a.on("click", ".edit",
                function(a) {
                    ...
                    null !== r && r != o ? (e(l, r), t(l, o), r = o) : r == o && "Save" == this.innerHTML ? (n(l, r), r = null, alert("更新成功！:)")) : (t(l, o), r = o)
                })
    };
    return {
        init: function() {
