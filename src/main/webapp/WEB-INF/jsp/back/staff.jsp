...
<div class="page-container">
                    ...
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">员工列表列表</span>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <c:forEach items="${staffList}" var="staff" >
                                    <tr>
                                        ...
                                        <td> ${staff.sGender} </td>
                                        <td> ${staff.sJob} </td>
                                        <td> ${staff.sPermission} </td>
                                        <td> ${staff.sRemarks} </td>
                                        <td> <fmt:formatDate value="${staff.sCreated}" type="BOTH" /> </td>
                                        <td> <fmt:formatDate value="${staff.sUpdated}" type="BOTH" /> </td>
                                        <td>
    ...
    <script src="resource/back/assets/pages/scripts/table-datatables-editableStaff.min.js" type="text/javascript"></script>
