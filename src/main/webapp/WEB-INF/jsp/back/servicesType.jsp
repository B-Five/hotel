...
<div class="page-container">
                    ...
                    <div class="portlet light portlet-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red sbold uppercase">服务类型列表</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <c:forEach items="${servicesTypeList}" var="servicesType" >
                                    <tr>
                                        <td> ${servicesType.stId} </td>
                                        <td> ${servicesType.stName}</td>
                                        <td> ${servicesType.stDesc} </td>
                                        <td> ${servicesType.stPrice} </td>
                                        <td> <fmt:formatDate value="${servicesType.stCreated}" type="BOTH" /> </td>
                                        <td> <fmt:formatDate value="${servicesType.stUpdated}" type="BOTH" /> </td>
                                        <td>
    ...
    <script src="resource/back/assets/pages/scripts/table-datatables-editableServicesType.min.js" type="text/javascript"></script>
