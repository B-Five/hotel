...
<div class="page-container">
                            ...
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <c:forEach items="${orderList}" var="order" >
                                    <tr>
                                        ...
                                        <td> ${order.oUid}</td>
                                        <td> ${order.oRid} </td>
                                        <td> <fmt:formatDate value="${order.oCheckintime}" /></td>
                                        <td> <fmt:formatDate value="${order.oCheckouttime}"/></td>
                                        <td> ${order.oDeposit} </td>
                                        <td> ${order.oPrice} </td>
                                        <td> ${order.oStatus} </td>
                                        <td> <fmt:formatDate value="${order.oCreated}" type="BOTH" /> </td>
                                        <td> <fmt:formatDate value="${order.oUpdated}" type="BOTH"/> </td>
                                        <td>
    ...
    <script src="resource/back/assets/pages/scripts/table-datatables-editableOrder.min.js" type="text/javascript"></script>
